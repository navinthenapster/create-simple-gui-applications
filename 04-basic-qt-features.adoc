...
feel free to experiment around it — particularly with reference to the http://doc.qt.io/qt-5/[Qt Documentation].
...
things happening in your application: _Signals_.
...
.HRH Queen Lizzy — Public domain.
image::hrh.jpg[scaledwidth=50%,align="center"]
